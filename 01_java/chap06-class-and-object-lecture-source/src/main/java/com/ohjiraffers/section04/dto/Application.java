...
public class Application {
    public static void main(String[] args) {
         ...
         * 예) 아이디, 비밀번호, 이름이 모두 oh인 경우
         * new User("oh", "oh", "oh", "oh") 몇번째 인자가 아이디 인지 보기 힘들다.
         * 2. 설정자(setter)를 이용한 초기화
         * 장점: 필드를 초기화하는 각각의 값들이 어떤 필드를 초기화하는지 명확하게 볼 수 있다.
         * 예) 아이디, 비밀번호, 이름이 모두 "oh"인 경우
         * User.user = new User();
         * User.userId("oh");
         * User.userPwd("oh");
         * User.userName("oh");
         ...
         * */
    UserDTO user1 = new UserDTO("ohjiraffers", "ohjiraffers","ohjiraffers", new java.util.Date());
        System.out.println(user1.getInformation());

//    UserDTO user2 = new UserDTO();
//    user2.setId("ohjiraffers");
//    user2.setPwd("ohjiraffers");
//    user2.setName("ohjiraffers");
