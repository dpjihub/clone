...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *
        * clone()은 이전 배열과 같은 배열밖에 만들 수 없다는 특징을 가지고 그 외 3가지 방법은
        * 복사하는 배열의 길이를 마음대로 조절할 수 있다는 특징을 가지고 있다.
        * */
        ...
        //매개변수의 값 순서는 원본배열, 복사를 시작할 인덱스, 복사본 배열, 복사를 시작할 인덱스, 복사할 길이
